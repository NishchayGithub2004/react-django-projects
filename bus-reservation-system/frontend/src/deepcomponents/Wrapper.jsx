...
import { Link, useNavigate } from 'react-router-dom'; // import 'useNavigate' hook from react-router-dom library to navigate b/w pages and 'Link' component to create links

// create a functional component 'Wrapper' that takes in props called 'token', 'handleLogout' and 'children'
const Wrapper = ({ token, handleLogout, children }) => {
  const navigate = useNavigate(); // create an instance of 'useNavigate' hook to navigate b/w pages

  // create a function 'logout' that calls 'handleLogout' prop and navigates to '/login' path
  const logout = () => {
    handleLogout();
    navigate('/login');
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-8">
              ...
              {/* this part is rendered only if 'token' exists ie user is logged in */}
              {token && (
                <Link 
                  to='/my-bookings' 
